%% linspaceNDim
% Linearly spaced multidimensional matrix.
%
% Example:
% |d1 = rand(3, 2, 4); d2 = rand(size(d1)); n = 1;| 
%
% |y = linspaceNDim(d1, d2, n)| returns a multidimensional matrix y of size (2, 4, 3, 10)
%
%% Syntax
% |y = linspaceNDim(d1, d2)|
%
% |y = linspaceNDim(d1, d2, n)|
%
%
%% Description
% |y = linspaceNDim(d1, d2)| generates a multi-dimensional matrix of 100 linearly equally spaced points between each element of matrices d1 and d2.
%
% |y = linspaceNDim(d1, d2, n)| generates N points between each element of matrices X1 and X2.
%
%
%% Input arguments
% |d1| - _SCALAR MATRIX_ - First boundary of the interpolation
%
% |d2| - _SCALAR MATRIX_ - Second boundary of the interpolation
%
% |n| - _INTEGER_ - Number of points in the interpolation
%
%
%% Output arguments
%
% |y| - _SCALAR MATRIX_ - multidimensional matrix of interpolated points
%
%
%% Contributors
% Authors : Steeve AMBROISE --> sambroise@gmail.com
