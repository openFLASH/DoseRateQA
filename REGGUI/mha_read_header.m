%% mha_read_header
% Read the header of a Insight Meta-Image (.mha,.mhd) file
%
%% Syntax
% |info =mha_read_header()|
%
% |info =mha_read_header(filename)|
%
%
%% Description
% |info =mha_read_header(filename)| Description
%
% |info =mha_read_header(filename)| Description
%
%
%% Input arguments
% |filename| - _STRING_ - Name of the MHA file to load
%
%
%% Output arguments
%
% |info| - _STRUCTURE_ - Structure containing the information of the MHA file.
%
%
%% Contributors
