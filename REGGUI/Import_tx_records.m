...
function [handles, beaminfo] = Import_tx_records(myLogDir,myLogFilename,format,myPlanName,handles,RefName,aggregate_paintings,overwrite_geometry,XDRconverter,merge_tuning)
...
try
    ...
    [myBeamData,myInfo, beaminfo] = load_DICOM_RT_Records(myLogFilename,format,ref_data,ref_info,'aggregate_paintings',aggregate_paintings,'overwrite_geometry',overwrite_geometry,'XDRconverter',XDRconverter,'merge_tuning',merge_tuning);
catch ME
