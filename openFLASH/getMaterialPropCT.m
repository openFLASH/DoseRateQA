...
%% Output arguments
%
% |HU| -_SCALAR_- Hounsfield unit of the material in the scanner interpolated from density vs HU curve of the CT scanner
%
...
function [HU, Density, SPR, SP, RelElecDensity] =  getMaterialPropCT(material, ScannerDirectory,MaterialsDirectory)
  ...
  [HUct, Densitiesct, SPRct, SPct, RelElecDensityct] = Compute_SPR_data(ScannerDirectory,MaterialsDirectory); %Read link between HU and physical properties
