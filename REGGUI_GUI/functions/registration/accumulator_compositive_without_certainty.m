%% accumulator_compositive_without_certainty
% Performing Additive accumulation (no damping of the accumulated field) of the deformation fields.
% The composite accumulation is described in section "3.3.1 Additive accumulation" of reference [1]
%
%% Syntax
% |[out_field, out_cert] = accumulator_compositive_without_certainty(acc_field, acc_cert, est_field, est_cert, acc_data)|
%
%
%% Description
% |[out_field, out_cert] = accumulator_compositive_without_certainty(acc_field, acc_cert, est_field, est_cert, acc_data)| returns the accumulated defomration field and the accumulated certainty about the value of the voxel intensity
%
%
%% Input arguments
...
function [out_field, out_cert] = accumulator_compositive_without_certainty(acc_field, acc_cert, est_field, est_cert, acc_data)

disp('Performing compositive accumulation (without certainty)...')
