%% regularisation_gauss
% Performs gaussian smoothing of the deformation/displacement field
%
%% Syntax
% |[out_field, out_cert] = regularisation_gauss(proc, in_field, in_cert, scale, data = VECTOR)|
%
% |[out_field, out_cert] = regularisation_gauss(proc, in_field, in_cert, scale, data=SCALAR)|
%
%
%% Description
% |[out_field, out_cert] = regularisation_gauss(proc, in_field, in_cert, scale, data)| Performs gaussian smoothing of the deformation/displacement field
%
%
%% Input arguments
%
...
function [out_field, out_cert] = regularisation_gauss(proc, in_field, in_cert, scale, data)
