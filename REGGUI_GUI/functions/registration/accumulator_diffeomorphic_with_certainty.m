%% accumulator_diffeomorphic_with_certainty
% Performing Diffeomorphic accumulation (WITH damping of the accumulated field) of the deformation fields.
% The accumulation is described in section "3.3.4 Diffeomorphic accumulation" (equation 3.17) of reference [1]
%
%% Syntax
% |[out_field, out_cert] = accumulator_diffeomorphic_with_certainty(acc_field, acc_cert, est_field, est_cert, acc_data)|
%
%
%% Description
% |[out_field, out_cert] = accumulator_diffeomorphic_with_certainty(acc_field, acc_cert, est_field, est_cert, acc_data)| returns the accumulated deformation field and the accumulated certainty about the value of the voxel intensity
%
%
%% Input arguments
...
function [out_field, out_cert] = accumulator_diffeomorphic_with_certainty(acc_field, acc_cert, est_field, est_cert, acc_data)

disp('Performing diffeomorphic accumulation (using certainty)...')

% Sum of certainties
cert_sum = acc_cert + est_cert;

for n = 1:length(est_field)
est_field{n} = est_field{n}.*est_cert./(cert_sum+eps);
end
