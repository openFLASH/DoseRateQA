%% Dilation
% Apply a dilation filter on an image. The function applies an |imdilate| filter.
%
%% Syntax
% |handles = Dilation(image,params=[x,y,z],im_dest,handles)|
%
% |handles = Dilation(image,params=[i,j],im_dest,handles)|
%
...
%
%% Description
% |handles = Dilation(image,params,im_dest,handles)| Apply a dilation filter on the image using a spheric kernel element
%
% |handles = Dilation(image,params,im_dest,handles,shape)| Apply a dilation filter on the image
%
%
%% Input arguments
...
function handles = Dilation(image,params,im_dest,handles,shape)
