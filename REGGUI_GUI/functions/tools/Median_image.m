%% Median_image
% Compute the median of chosen images stored either in |handles.mydata| or |handles.images| or of deformation fields in |handles.fields| 
%
%% Syntax
% |handles = Median_image(imageNames,outname,handles,datatype)|
%
%
%% Description
% |handles = Median_image(imageNames,outname,handles,datatype))| computes the median of the selected images or fields
%
%
%% Input arguments
% |imageNames| - _CELL VECTOR of STRING_ -  |imageNames{i}| Name of the ith image in |handles.images|, |handles.fileds| or |handles.mydata| that is included in the median
%
...
function handles = Median_image(imageNames,outname,handles,datatype)
...
if datatype ==1
    ...
    % Compute the median for each slice
    for s=1:size(res,3)
