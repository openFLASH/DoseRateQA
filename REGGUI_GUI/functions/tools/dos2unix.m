%% dos2unix
% Convert the format of text files contained in a directory from the DOS/Windows format to the Unix format. The function converts the CR/LF characters into LF character.
%
% Example: dos2unix(Pfad,'-r','.ext')
%
%% Syntax
% |dos2unix(recur,ext)|
%
% |dos2unix(Pfad,recur,ext)|
%
%
%% Description
% |dos2unix(recur,ext)| Convert the files of the current working directory
%
% |dos2unix(Pfad,recur,ext)| Convert the files of the specified directory
%
%
%
%% Input arguments
% |Pfad| - _STRING_ - [OPTIONAL. Default: current working directory] Directory to be parsed
%
% |recur| - _STRING_ - If equal to '-r', then the folder is recursively scanned
%
% |ext| - _STRING_ - Extension (including dot '.'). Only the file with this extension will be converted.
%
%
%% Output arguments
%
