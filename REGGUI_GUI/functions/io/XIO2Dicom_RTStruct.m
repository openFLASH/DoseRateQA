%% XIO2Dicom_RTStruct
% Read DICOM file RTF generated by XIO from disk, udate the DICOM tags with information contained in an image stored in |handles.images| or |handles.mydata| and save the result to disk as a DICOM RT struct file.
% The DICOM frame of reference is copied from the CT scan (= |imageName|)
%
%% Syntax
% |res = XIO2Dicom_RTStruct(handles)|
%
% |res = XIO2Dicom_RTStruct(handles,imageName)|
%
% |res = XIO2Dicom_RTStruct(handles,imageName,RTFileName)|
%
%
%% Description
% |res = XIO2Dicom_RTStruct(handles)| The RT struc file and the associated REGGUI image are selected manually
%
% |res = XIO2Dicom_RTStruct(handles,imageName)| The RT struc file is selected manually.
%
% |res = XIO2Dicom_RTStruct(handles,imageName,RTFileName)| Export the DICOM file of the RT-struct
%
%
%% Input arguments
...
function res = XIO2Dicom_RTStruct(handles,imageName,RTFileName)
...
try
    ...
    dicomwrite([],[RTFileName '_dicom.dcm'],infoRS,'CreateMode','Copy');
