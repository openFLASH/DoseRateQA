function varargout = margin_recipe(varargin)
% MARGIN_RECIPE M-file for margin_recipe.fig
%      MARGIN_RECIPE, by itself, creates a new MARGIN_RECIPE or raises the existing
%      singleton*.
%
%      H = MARGIN_RECIPE returns the handle to a new MARGIN_RECIPE or the handle to
%      the existing singleton*.
%
%      MARGIN_RECIPE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MARGIN_RECIPE.M with the given input arguments.
%
%      MARGIN_RECIPE('Property','Value',...) creates a new MARGIN_RECIPE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before margin_recipe_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to margin_recipe_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help margin_recipe

% Last Modified by GUIDE v2.5 20-Feb-2012 15:46:24

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @margin_recipe_OpeningFcn, ...
    'gui_OutputFcn',  @margin_recipe_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before margin_recipe is made visible.
function margin_recipe_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to margin_recipe (see VARARGIN)
...
function varargout = margin_recipe_OutputFcn(hObject, eventdata, handles)
