...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
	...
	/* Outputs */
	mxArray *jacobian;
	float	*datj;	/* determinant of field jacobian */
	...
	jacobian = mxCreateNumericArray(3, sizf, mxSINGLE_CLASS, mxREAL);

	/* Get pointer to the field. */
	datf = (float*)mxGetPr(prhs[0]);

	/* Get pointer to the jacobian. */
	datj = (float*)mxGetPr(jacobian);
	...
	for (k = 0; k <= ubkf; k++)
	{
		for (j = 0; j <= ubjf; j++)
		{
			...
			{	/* index */
				...
				/* determinant */
				datj[indf] = ((mat9[0]<0.0 || mat9[4]<0.0 || mat9[8]<0.0)? -1.0: +1.0) * fabs( mat9[0]*mat9[4]*mat9[8] + mat9[1]*mat9[5]*mat9[6] + mat9[2]*mat9[3]*mat9[7] - mat9[6]*mat9[4]*mat9[2] - mat9[7]*mat9[5]*mat9[0] - mat9[8]*mat9[3]*mat9[1]);
/* Harmonic energy : ( ((mat9[0]-1.0)*(mat9[0]-1.0)) + (mat9[1]*mat9[1]) + (mat9[2]*mat9[2]) + (mat9[3]*mat9[3]) + ((mat9[4]-1.0)*(mat9[4]-1.0)) + (mat9[5]*mat9[5]) + (mat9[6]*mat9[6]) + (mat9[7]*mat9[7]) + ((mat9[8]-1.0)*(mat9[8]-1.0)) ) /2.0 */
			}
		}
	}
