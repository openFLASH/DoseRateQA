%% ordfilt3D
% Same as ordfilt2 but for 3D dataset. Perform 3-D order-statistic filtering on 26 neighbors
%
%% Syntax
...
%
%% Description
% |[Vr] = ordfilt3D(V0,ord,padoption)| Perform 3-D order-statistic filtering on 26 neighbors
%
%
%% Input arguments
% |V0| - _SCALAR MATRIX_ - Data to be filtered
%
% |ord| - _INTEGER_ - Filter
%
% * |ord = 14| :  median filtering
% * |ord = 1| :  min
% * |ord = [1 27]| :  [min max]
%
% |padoption| - _STRING_ - Controls how the matrix boundaries are padded. Same as in padarray
%
%
%% Output arguments
%
% |Vr| - _SCALAR MATRIX_ - Resulting dataset
%
%
%% Contributors
% Authors : Olivier Salvado, Case Western Reserve University, 16Aug04
