...
%
% The problem to be solved : There is only one colormap per figure. This function provides an easy solution when plots using different colomaps are desired in the same figure.
%
...
%
% The original indexed color data is saved, and can be restored using unfreezeColors, making the plot once again subject to the colormap and caxis.
%
%% Syntax
%       freezeColors        
%       freezeColors(axh)   
...
%
%% Input arguments
% |axh| - _GRAPHIC HANDLE_ - Handle to axis 
%
%
%% Output arguments
%
...
%
%% Contributors
% Authors : John Iversen, john_iversen@post.harvard.edu
