...
%
%% Syntax
% |[handles,levels,parentIdx,listing] = (container, 'PropName',PropValue(s), ...)|
%
%
%% Description
...
%
%% Input arguments
% |container| - _Graphic handle_ - - optional handle to java container uipanel or figure. If unsupplied then current figure will be used
%
...
% * ----- Note1: passing a property value is possible if the argument following 'property' is a cell in the format of {'propName','propValue'}. Example: FINDJOBJ(...,'property',{'Text','click me'})
...
% * 'nomenu'   - skip menu processing, for "lean" list of handles & much faster processing. This option is the default for HG containers but not for figure, Java or no container
...
% * ----- Note2: normally this option would be placed last, after all filtering is complete. Placing this option before some filters enables debug print-outs of interim filtering results.
...
%
% Note: If no output parameter is specified, then an interactive window will be displayed with a ^^^^  tree view of all container components, their properties and callbacks.
%
%
%% Contributors
% Authors :  Yair M. Altman: altmany(at)gmail.com
%
%% License
