%% unfreezeColors
% Restore colors of a plot to original indexed color.
% Has no effect on objects on which freezeColors was not already called.
% (Note: if colorbars were frozen using cbfreeze, use cbfreeze('off') to unfreeze them. 
%
%% Syntax
% |unfreezeColors(h)|
%
...
%
%% Input arguments
% |axh| - _VECTOR_ - axis handle. axh can be vector.
%
% |figh| - _VECTOR_ - figure handle. 
%
%
%% Output arguments
%
