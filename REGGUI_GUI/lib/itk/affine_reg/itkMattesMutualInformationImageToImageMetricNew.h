/*=========================================================================
  ...
  Module:    $RCSfile: itkMattesMutualInformationImageToImageMetricNew.h,v $
  Language:  C++
  Date:      $Date: 2005/10/31 22:14:35 $
...
=========================================================================*/
#ifndef __itkMattesMutualInformationImageToImageMetricNew_h
#define __itkMattesMutualInformationImageToImageMetricNew_h
...
// Added
#include "itkLocalJacobianTransform.h"

namespace itk
{

/** \class MattesMutualInformationImageToImageMetricNew
 * \brief Computes the mutual information between two images to be 
 * registered using the method of Mattes et al.
 *
 * MattesMutualInformationImageToImageMetricNew computes the mutual 
...
class ITK_EXPORT MattesMutualInformationImageToImageMetricNew :
    public ImageToImageMetric< TFixedImage, TMovingImage >
{
public:

  /** Standard class typedefs. */
  typedef MattesMutualInformationImageToImageMetricNew  Self;
  ...
  itkTypeMacro(MattesMutualInformationImageToImageMetricNew, ImageToImageMetric);
  ...
  /** Helper type. */
  typedef MattesMutualInformationHelper<TFixedImage, TMovingImage>
                                                        HelperType;
  typedef typename HelperType::Pointer                  HelperPointerType;
  typedef typename HelperType::ImageDerivativesType     ImageDerivativesType;
   ...
   *      the FixedImageRegion (done in the helper class), and 
...
protected:
  ...
  virtual ~MattesMutualInformationImageToImageMetricNew() {};
  void PrintSelf(std::ostream& os, Indent indent) const;

  /** Helper. */
  HelperPointerType m_Helper;
...
private:
  ...
  MattesMutualInformationImageToImageMetricNew(const Self&); //purposely not implemented
  ...
  /** Added : Boolean to indicate if "local jacobian" type. */
  bool m_TransformIsLocalJacobian;
  ...
  // Added : typedef for local jacobian transformation
  typedef LocalJacobianTransform<
    CoordinateRepresentationType,
    ::itk::GetImageDimension<FixedImageType>::ImageDimension>
    LocalJacobianTransformType;
  ...
  /**
   * Added : Variables used when transform is of type LocalJacobian.
   */
  typename LocalJacobianTransformType::Pointer m_LocalJacobianTransform;
...
#include "itkMattesMutualInformationImageToImageMetricNew.txx"
#endif
