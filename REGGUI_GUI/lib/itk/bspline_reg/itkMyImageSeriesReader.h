/*=========================================================================
  ...
  Module:    $RCSfile: itkMyImageSeriesReader.h,v $
  Language:  C++
  Date:      $Date: 2004/09/03 23:47:54 $
...
=========================================================================*/
#ifndef __itkMyImageSeriesReader_h
#define __itkMyImageSeriesReader_h
...
class ITK_EXPORT MyImageSeriesReader : public ImageSource<TOutputImage>
{
public:
  /** Standard class typedefs. */
  typedef MyImageSeriesReader          Self;
  ...
  itkTypeMacro(MyImageSeriesReader, ImageSource);
   ...
   * MyImageSeriesReader uses the factory mechanism of the
   ...
   * output than it was requested to produce. MyImageSeriesReader cannot
   * currently read a portion of an image (since the ImageIO objects
   * cannot read a portion of an image), so the MyImageSeriesReader must
...
protected:
  MyImageSeriesReader() : m_ImageIO(0), m_ReverseOrder(false) {};
  ~MyImageSeriesReader();
...
private:
  MyImageSeriesReader(const Self&); //purposely not implemented
...
#include "itkMyImageSeriesReader.txx"
#endif

#endif // __itkMyImageSeriesReader_h
